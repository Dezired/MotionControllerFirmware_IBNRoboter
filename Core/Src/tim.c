...
void MX_TIM2_Init(void)
{
  ...
  sSlaveConfig.SlaveMode = TIM_SLAVEMODE_RESET;  // Setzt den Zähler auf 0, wenn PD3 (ETR) eine steigende Flanke sieht
  sSlaveConfig.InputTrigger = TIM_TS_ETRF;       // Nutzt ETR (PD3) als Reset-Trigger
  sSlaveConfig.TriggerPolarity = TIM_TRIGGERPOLARITY_RISING; // Steigende Flanke nutzen
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PD4     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = T2_CH1_ENCODER_A_A_NEU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(T2_CH1_ENCODER_A_A_NEU_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = GPIO_PIN_3|T2_CH2_ENCODER_A_A_NEU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM5_MspInit 0 */
    ...
    PF6     ------> TIM5_ETR
    */
    GPIO_InitStruct.Pin = T5_CH_2_ENCODER_B_B_NEU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM5;
    HAL_GPIO_Init(T5_CH_2_ENCODER_B_B_NEU_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = T5_CH2_ENCODER_B_A_NEU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(T5_CH2_ENCODER_B_A_NEU_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = T5_ETR_ENCODER_B_INDEX_NEU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM5;
    HAL_GPIO_Init(T5_ETR_ENCODER_B_INDEX_NEU_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIMEx_HallSensor_MspInit(TIM_HandleTypeDef* timex_hallsensorHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PD14     ------> TIM4_CH3
    */
    GPIO_InitStruct.Pin = T4_CH1_MOT_B_HALL_A_NEU_Pin|T4_CH2_MOT_B_HALL_B_NEU_Pin|T4_CH3_MOT_B_HALL_C_NEU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(timex_hallsensorHandle->Instance==TIM8)
  {
  ...
  /* USER CODE END TIM8_MspInit 0 */
    ...
    PB9     ------> TIM8_CH3
    */
    GPIO_InitStruct.Pin = T8_CH1_MOT_A_HALL_A_NEU_Pin|T8_CH2_MOT_A_HALL_B_NEU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = T8_CH3_MOT_A_HALL_C_NEU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF10_TIM8;
    HAL_GPIO_Init(T8_CH3_MOT_A_HALL_C_NEU_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PC3     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = T1_CH1_PWM_Mot_A_A_Pin|T1_CH2_PWM_Mot_A_B_Pin|T1_CH3_PWM_Mot_A_C_Pin|T1_CH4_PWM_Mot_A_D_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    PF10     ------> TIM15_CH2
    */
    GPIO_InitStruct.Pin = T15_CH1_BRAKE_A_NEU_Pin|T15_CH2_BRAKE_B_NEU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PD4     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(T2_CH1_ENCODER_A_A_NEU_GPIO_Port, T2_CH1_ENCODER_A_A_NEU_Pin);

    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_3|T2_CH2_ENCODER_A_A_NEU_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PF6     ------> TIM5_ETR
    */
    HAL_GPIO_DeInit(GPIOF, T5_CH_2_ENCODER_B_B_NEU_Pin|T5_ETR_ENCODER_B_INDEX_NEU_Pin);

    HAL_GPIO_DeInit(T5_CH2_ENCODER_B_A_NEU_GPIO_Port, T5_CH2_ENCODER_B_A_NEU_Pin);
...
void HAL_TIMEx_HallSensor_MspDeInit(TIM_HandleTypeDef* timex_hallsensorHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD14     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(GPIOD, T4_CH1_MOT_B_HALL_A_NEU_Pin|T4_CH2_MOT_B_HALL_B_NEU_Pin|T4_CH3_MOT_B_HALL_C_NEU_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PB9     ------> TIM8_CH3
    */
    HAL_GPIO_DeInit(GPIOC, T8_CH1_MOT_A_HALL_A_NEU_Pin|T8_CH2_MOT_A_HALL_B_NEU_Pin);

    HAL_GPIO_DeInit(T8_CH3_MOT_A_HALL_C_NEU_GPIO_Port, T8_CH3_MOT_A_HALL_C_NEU_Pin);
