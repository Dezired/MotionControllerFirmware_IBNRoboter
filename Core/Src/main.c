...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, MOT_A_M1_Pin|MOT_A_M2_Pin|MOT_A_M3_NEU_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MOT_A_TEMP_FAULT_NEU_Pin MOT_A_FAULT_Pin MOT_B_TEMP_FAULT_Pin */
  GPIO_InitStruct.Pin = MOT_A_TEMP_FAULT_NEU_Pin|MOT_A_FAULT_Pin|MOT_B_TEMP_FAULT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : MOT_A_M1_Pin MOT_A_M2_Pin MOT_A_M3_NEU_Pin */
  GPIO_InitStruct.Pin = MOT_A_M1_Pin|MOT_A_M2_Pin|MOT_A_M3_NEU_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
